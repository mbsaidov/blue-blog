  ...
  <div class="content"><!-- InstanceBeginEditable name="icerik" -->  <h2>//Kategori<span> Ekle</span></h2>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table width="100%" align="center">
          <tr valign="baseline">
            <td height="42" align="right" valign="middle" nowrap="nowrap" bgcolor="#E8E8E8"><h4>Kategori İsmi:</h4></td>
            <td valign="middle" bgcolor="#E8E8E8"><input type="text" name="ad" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
        <td height="37" align="right" nowrap="nowrap" bgcolor="#E8E8E8"><h5>Kategori İcon URL(Varsayılan İçin: resimler/icog.png):</h5></td>
...
<br />
   <table width="100%">
     <tr>
       <td width="68%" height="39" align="center"><h4>Kategori İsmi</h4></td>
