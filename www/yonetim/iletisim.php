...
<div class="genel">
  ...
  <table width="100%" align="center">
    ...
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#E9E9E9"><h4>Twitter Hesabı:</h4></td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="left"><h4>Google+ Hesabı:</h4></td>
      <td><input type="text" name="plus" value="<?php echo htmlentities($row_iletisim_duzenle['plus'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#E9E9E9"><h4>Youtube Kanalı:</h4></td>
    ...
    <tr valign="baseline">
      ...
      <td bgcolor="#E9E9E9"><input type="submit" value="Bilgileri Güncelle" /></td>
    </tr>
  </table>
