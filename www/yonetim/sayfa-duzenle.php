...
<div class="genel">
  ...
  <form name="formsayfa" method="POST" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data">
    	...
    	<table width="100%" border="0">
    	  <tr>
    	    <td height="83" colspan="2" bgcolor="#EFEFEF">&nbsp;    	      <input name="u_ad" type="text" id="baslik1" value="<?php echo $row_sayfa_duzenle['baslik']; ?>" size="110" placeholder="Başlığı Girin" /></td>
   	      </tr>
    	  <tr>
